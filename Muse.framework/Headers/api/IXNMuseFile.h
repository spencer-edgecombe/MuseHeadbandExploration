 ...
 * \caseparam{forWriting, forWriting, \c true if the file should be opened for writing. \c false if for reading.}
 ...
 * \caseparam{forWriting, forWriting, \c true if the file should be closed for writing. \c false if for reading.}
